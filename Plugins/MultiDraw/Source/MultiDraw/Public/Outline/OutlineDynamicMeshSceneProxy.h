...
class FOutlineDynamicMeshSceneProxy : public FBaseDynamicMeshSceneProxy
{
...
public:
	UPROPERTY()
	UOutlineDynamicMeshComponent* ParentComponent;
	
	FOutlineDynamicMeshSceneProxy(UOutlineDynamicMeshComponent* Component, EMultiDrawCullingMode CullingMode,bool bCastShadow);
...
public:
	...
	virtual void DrawOutlineBatch(FMeshElementCollector& Collector,
