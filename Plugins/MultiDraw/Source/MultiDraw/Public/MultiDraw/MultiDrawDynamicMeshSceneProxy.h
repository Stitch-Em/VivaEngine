...
class FMultiDrawDynamicMeshSceneProxy : public FBaseDynamicMeshSceneProxy
{
...
public:
	UPROPERTY()
	UMultiDrawDynamicMeshComponent* ParentComponent;
	
	FMultiDrawDynamicMeshSceneProxy(UMultiDrawDynamicMeshComponent* Component);
...
public:
	...
	virtual void DrawBatch(FMeshElementCollector& Collector,
		...
		int ViewIndex,
		FDynamicPrimitiveUniformBuffer& DynamicPrimitiveUniformBuffer) const override;

	virtual void DrawMultiDrawBatch(FMeshElementCollector& Collector,
